...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Worker.machine'
        db.alter_column(u'factopy_worker', 'machine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['factopy.Machine'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Worker.machine'
        raise RuntimeError("Cannot reverse this migration. 'Worker.machine' and its values cannot be restored.")
    ...
    models = {
        ...
        'factopy.worker': {
            ...
            u'backendmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['factopy.BackendModel']", 'unique': 'True', 'primary_key': 'True'}),
            'machine': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['factopy.Machine']", 'null': 'True'})
        }
    }
